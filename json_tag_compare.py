...
url = "https://www.microsoft.com/en-us/download/confirmation.aspx?id=57063"[0].encode('UTF-8')
...
def json_compare():
    ...
    #os.chdir(r'C:\\Users\gmcnamara\Documents\azure_json_tags')

    # Find and read json files
    with open(r'azure_gov_ip1_2018-06-21.json') as fh:
        file_a = json.load(fh)
